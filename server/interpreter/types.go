...
// are a few interpreter-internal types that occasionally need to
// masquerade as if they were data.Value objects.  We define here some
// type constants that their Type() methods can return.
const (
