...
(function() {
  ...
  var struct = [
    ...
    [String, 'String',
     ['fromCharCode'],
     ['trim', 'toLowerCase', 'toUpperCase', 'toLocaleLowerCase', 'toLocaleUpperCase', 'charAt', 'charCodeAt', 'substring', 'slice', 'substr', 'indexOf', 'lastIndexOf', 'concat', 'localeCompare', 'split', 'match', 'search', 'replace', 'valueOf']],
    [Boolean, 'Boolean',
     [],
     ['valueOf']],
    [Number, 'Number',
     [],
     ['toExponential', 'toFixed', 'toPrecision', 'toString', 'toLocaleString', 'valueOf']],
    [Date, 'Date',
     ['now', 'parse', 'UTC'],
