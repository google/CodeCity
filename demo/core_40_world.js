...
(function () {
  ...
  var chris = '4b567644d33ad68a38a45d3fb61e5a53a64cf261ea2516d9a3de5235e75d7490b9bd7b2dc12f64182f9b9b50ddb113f257803c1d069cbb32da1719d06a567cee';
  var neil = '1387bfc24b159b3bd6ea187c66551d6b08f52dafb7fe5c3a5a93478f54ac6202b8f78efe5817015c250173b23a70f7f6ef3205e9f5d28730e0ff2033cc6fcf84';

  var bob = Object.create($.user);
  bob.name = 'Chris';
  $.userDatabase[chris] = bob;
  ...
  var bob2 = Object.create($.user);
  bob2.name = 'Neil';
  $.userDatabase[neil] = bob2;
  bob2.description = 'Looks a bit Canadian.';
  bob2.svgText = '<path d="m 7.01,77.6 c 1.6,-5.5 3.39,-12.3 5.29,-18.6 2.1,6.5 3.5,15.1 4.8,18.6" />';
  bob2.svgText += '<path d="m 5.84,99.5 c 2.86,-6.7 4.56,-16.1 6.66,-24.7 2,6.6 3.9,15.9 5.9,24.7" />';
  bob2.svgText += '<path d="m 12.5,75.6 c -0.6,-7.4 -0.4,-12.1 -0.1,-17" />';
  bob2.svgText += '<path d="m 12.3,58.5 c 2.4,0.8 5.6,0.4 7.6,-1.2 2.5,-2 3.7,-5.8 3.3,-9 -0.3,-2.6 -2.2,-5.3 -4.6,-6.5 -3,-1.5 -7.4,-1.8 -10.1,0.2 -2.58,1.9 -3.75,6 -3.08,9.1 0.71,3.3 3.7,6.3 6.88,7.4 z" class="fillWhite" />';
  bob2.svgText += '<path d="m 6.48,53.4 c -0.1,-2.2 1.1,-5.7 4.42,-3.6 6,3.8 12.3,-3.5 11.3,-4.3 l 0,0" />';
  bob2.svgText += '<path d="m 6.06,52.6 c -1.34,3.2 -1.54,7.1 -1.18,10.3 -0.15,-2.5 -4.525,-7.7 -4.243,-11.4 0.403,-5.3 2.783,-5.9 4.573,-3.6 0,2.3 0.28,3.8 0.85,4.7 z" class="fillWhite" />';

  var alice = Object.create($.user);
  alice.name = 'Maggie';
  $.userDatabase['maggie'] = alice;
  alice.description = 'Lord of all who report to her.';
...
/*
'<path d="m 15.4,98.6 c -0.1,0.2 -0.7,0.2 -1.5,0 -0.4,-0.4 0.2,-2.1 1.9,-2.3 0.1,-2.3 0.2,-5.1 -0.2,-7" class="fillWhite" />' +
'<path d="m 15,85.9 c -0.8,4 5,9.9 11.2,11.7 9.7,2.4 12,-4.2 7.6,-11.2 -1.3,-2 -5.6,-7.8 -13,-5.5 2.4,-9.3 -10.6,-16 -12.22,-3.8 -5.9,2.1 -10.5,6.7 -2.5,9.8 5.02,1.9 10.82,-1.8 13.32,-4.3" class="fillWhite" />' +
'<path d="m 20.8,91.5 c -0.1,1.3 -0.2,2.5 -1.4,3.8 0,1.1 0.3,2 -0.1,3.3 -0.7,1.2 -1.6,1 -2.4,1 -2.7,-0.1 -1.3,-2.3 0.1,-2.9 0.5,-3.8 -0.3,-5.7 -0.4,-8.5" class="fillWhite" />' +
'<circle r="0.377" cy="77.2" cx="11.4" class="fillBlack" />' +
'<path d="m 32.7,96.6 c -0.4,1 -0.7,2 -1.4,2.9 -2.2,-0.3 -5.9,0.4 -8.9,0.5 -0.6,-1.8 -0.6,-3.4 2.4,-1.8 l 2.8,-0.3 c -5.7,-4.8 0.4,-7.3 2.2,-5.6" class="fillWhite" />' +
'<path d="m 20.6,75.6 c -1,4.4 -4,4.9 -4.7,-0.5 -0.2,-1.5 -1.8,-2.9 -1,-4.4" class="fillWhite" />' +
'<path d="m 36,92.1 c 0,0 2.5,-2.2 4.3,-4.7 1.9,-2.8 3.6,-4 2.2,1.1 -1.1,3.7 -0.9,4.5 -6.5,5" class="fillWhite" />' +
'<path d="m 40.2,84.8 c -1.2,0.7 -2,2.2 -2.6,4" class="fillWhite" />' +
'<path d="m 39.1,83.2 c -1.3,0.9 -2.1,1.9 -2.4,2.8" class="fillWhite" />' +
'<path d="m 44.2,90.6 c -0.6,3.5 -3.7,5.3 -5.8,5" class="fillWhite" />' +
'<path d="m 44.7,95 c -0.9,1.7 -3.3,3.7 -5,2.9" class="fillWhite" />' +
'<path d="m 5.88,84.2 c 0,0 -0.4,1.2 -3.1,0.8" class="fillWhite" />'
*/
