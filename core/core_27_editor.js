...
Object.setOwnerOf($.http['code.']['/'].www, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/'].www.prototype, $.physicals.Neil);
...
Object.setOwnerOf($.http['code.']['/'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/'].www.compiled_.prototype, $.physicals.Neil);
...
Object.setOwnerOf($.http['code.']['/editor'].www, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/editor'].www.prototype, $.physicals.Neil);
...
Object.setOwnerOf($.http['code.']['/editor'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/editor'].www.compiled_.prototype, $.physicals.Neil);
...
Object.setOwnerOf($.http['code.']['/explorer'].www, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/explorer'].www.prototype, $.physicals.Neil);
...
Object.setOwnerOf($.http['code.']['/explorer'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/explorer'].www.compiled_.prototype, $.physicals.Neil);
...
Object.setOwnerOf($.http['code.']['/diff'].www, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/diff'].www.prototype, $.physicals.Neil);
...
Object.setOwnerOf($.http['code.']['/diff'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/diff'].www.compiled_.prototype, $.physicals.Neil);
...
Object.setOwnerOf($.http['code.']['/objectPanel'].www, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/objectPanel'].www.prototype, $.physicals.Neil);
...
Object.setOwnerOf($.http['code.']['/objectPanel'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/objectPanel'].www.compiled_.prototype, $.physicals.Neil);
...
Object.setOwnerOf($.http['code.']['/objectPanel'].getType, $.physicals.Neil);
...
Object.setOwnerOf($.http['code.']['/objectPanel'].buildData, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/objectPanel'].buildData.prototype, $.physicals.Neil);
$.http['code.']['/editorXhr'] = {};
Object.setOwnerOf($.http['code.']['/editorXhr'], $.physicals.Neil);
...
Object.setOwnerOf($.http['code.']['/editorXhr'].www, $.physicals.Neil);
$.http['code.']['/editorXhr'].load = function load(binding) {
...
Object.setOwnerOf($.http['code.']['/editorXhr'].load, $.physicals.Maximilian);
$.http['code.']['/editorXhr'].save = function $_www_code_editor_save(src, binding, data, user) {
...
Object.setOwnerOf($.http['code.']['/editorXhr'].save, $.physicals.Neil);
$.http['code.']['/editorXhr'].handleMetaData = function handleMetaData(src, oldValue, newValue) {
...
Object.setOwnerOf($.http['code.']['/editorXhr'].handleMetaData, $.physicals.Neil);
$.http['code.']['/editorXhr'].generateMetaData = function generateMetaData(value, inherited) {
...
Object.setOwnerOf($.http['code.']['/editorXhr'].generateMetaData, $.physicals.Neil);
$.http['code.']['/svg'] = {};
Object.setOwnerOf($.http['code.']['/svg'], $.physicals.Neil);
// CLOSURE: type: function, vars: source, jssp
// CLOSURE: type: funexp, vars: Jssp
...
Object.setOwnerOf($.http['code.']['/svg'].www, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/svg'].www.prototype, $.physicals.Neil);
...
Object.setOwnerOf($.http['code.']['/svg'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/svg'].www.compiled_.prototype, $.physicals.Neil);
Object.defineProperty($.http['code.']['/svg'].www.compiled_, 'name', {value: "$.http['code.']['/svg'].www.compiled_"});
$.http['code.']['/login'] = {};
Object.setOwnerOf($.http['code.']['/login'], $.physicals.Neil);
// CLOSURE: type: function, vars: source, jssp
// CLOSURE: type: funexp, vars: Jssp
...
Object.setOwnerOf($.http['code.']['/login'].www, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/login'].www.prototype, $.physicals.Neil);
$.http['code.']['/login'].www.source = '<!doctype html>\n<html lang="en">\n<head>\n  <title>Code City Login</title>\n  <style>\n    body {\n      font-family: "Roboto Mono", monospace;\n      text-align: center;\n    }\n    h1 {\n      font-size: 40pt;\n      font-weight: 100;\n    }\n    h1>img {\n      vertical-align: text-bottom;\n    }\n    #tagline {\n      font-style: italic;\n      margin: 2em;\n    }\n    iframe {\n      height: 50px;\n      width: 100px;\n      border: none;\n      display: block;\n      margin: 0 auto;\n    }\n  </style>\n  <link href="https://fonts.googleapis.com/css?family=Roboto+Mono" rel="stylesheet">\n  <link href="<%=$.servers.http.makeUrl(\'static\', \'favicon.ico\')%>" rel="shortcut icon">\n</head>\n<body>\n  <h1>\n    <img src="<%=$.servers.http.makeUrl(\'static\', \'logo.svg\')%>" alt="" width="95" height="100">\n    Code City\n  </h1>\n  <p id="tagline">Login required to edit code.</p>\n  <iframe src="<%=$.servers.http.makeUrl(\'login\', \'?loginThenClose&after=\' + \n                                         $.servers.http.makeUrl(\'www\', \'login-close.html\'))%>"></iframe>\n</body>\n</html>';
$.http['code.']['/login'].www.hash_ = '6b0bc30664b0e15dc64a4f52f736d0a9v1.0.0';
...
response.write($.servers.http.makeUrl('login', '?loginThenClose&after=' + 
                                         $.servers.http.makeUrl('www', 'login-close.html')));
response.write("\"></iframe>\n</body>\n</html>");
};
Object.setOwnerOf($.http['code.']['/login'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/login'].www.compiled_.prototype, $.physicals.Neil);
