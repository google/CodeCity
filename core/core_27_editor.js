...
$.hosts.code['/'].www = function jssp(request, response) {
...
Object.setPrototypeOf($.hosts.code['/'].www, $.Jssp.prototype);
Object.setOwnerOf($.hosts.code['/'].www, $.physicals.Neil);
Object.setOwnerOf($.hosts.code['/'].www.prototype, $.physicals.Neil);
$.hosts.code['/'].www.source = '<!DOCTYPE HTML Frameset DTD>\n<% var staticUrl = request.hostUrl(\'static\'); %>\n<html>\n<head>\n  <title>Code City: Code</title>\n  <link href="<%=staticUrl%>favicon.ico" rel="shortcut icon">\n  <script src="<%=staticUrl%>code/common.js"></script>\n  <script src="<%=staticUrl%>code/code.js"></script>\n</head>\n<frameset rows="40%,60%">\n  <frame id="explorer" src="explorer" />\n  <frame id="editor" src="editor" />\n</frameset>\n<noframes>Sorry, your browser does not support frames!</noframes>\n</html>';
$.hosts.code['/'].www.hash_ = 'a70db25ab77f7d662b2c0c9498650310v1.0.0';
$.hosts.code['/'].www.compiled_ = function(request, response) {
// DO NOT EDIT THIS CODE: AUTOMATICALLY GENERATED BY JSSP.
...
response.write(staticUrl);
response.write("CodeMirror/addon/mode/multiplex.js\"></script>\n    <script src=\"");
response.write(staticUrl);
...
response.write(staticUrl);
response.write("CodeMirror/mode/css/css.js\"></script>\n    <script src=\"");
response.write(staticUrl);
response.write("CodeMirror/mode/htmlembedded/htmlembedded.js\"></script>\n    <script src=\"");
response.write(staticUrl);
response.write("CodeMirror/mode/htmlmixed/htmlmixed.js\"></script>\n    <script src=\"");
response.write(staticUrl);
response.write("CodeMirror/mode/javascript/javascript.js\"></script>\n    <script src=\"");
response.write(staticUrl);
response.write("CodeMirror/mode/xml/xml.js\"></script>\n\n    <script src=\"");
response.write(staticUrl);
response.write("code/common.js\"></script>\n    <script id=\"editor_js\" src=\"");
response.write(staticUrl);
response.write("code/editor.js\"></script>\n  </head>\n  <body>\n    <div id=\"editorDialog\">\n      <div id=\"editorDialogMask\"></div>\n      <div id=\"editorDialogBox\">\n        <div id=\"editorConfirmBox\">\n          <p>Do you want to save changes?</p>\n          <p>\n            <button id=\"editorConfirmDiscard\" class=\"jfk-button\">Discard</button>\n            <button id=\"editorConfirmSave\" class=\"jfk-button jfk-button-submit\">Save</button>\n            <button id=\"editorConfirmCancel\" class=\"jfk-button\">Cancel</button>\n          </p>\n        </div>\n        <div id=\"editorShareBox\" class=\"disabled\">\n          <p>\n            <label><input type=\"checkbox\" id=\"editorShareCheck\" disabled> Share this editor:</label>\n          </p>\n          <p>\n            <input id=\"editorShareAddress\" readonly>\n          </p>\n          <p>\n            <button id=\"editorShareOk\" class=\"jfk-button jfk-button-submit\">Ok</button>\n          </p>\n        </div>\n      </div>\n    </div>\n    <div id=\"editorButter\"><div><div id=\"editorButterText\"></div></div></div>\n    <div id=\"editorSavingMask\"></div>\n    <div id=\"editorButtons\">\n      <button id=\"editorShare\" class=\"jfk-button\">Share...</button>\n      <button id=\"editorSave\" class=\"jfk-button\">Save</button>\n    </div>\n    <div id=\"editorTabs\" class=\"disabled\">\n      <span class=\"spacer\"></span>\n    </div>\n    <div id=\"editorHeader\" class=\"loading\"></div>\n    <div id=\"editorContainers\"></div>\n  </body>\n</html>");
};
Object.setOwnerOf($.hosts.code['/editor'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.hosts.code['/editor'].www.compiled_.prototype, $.physicals.Neil);
Object.defineProperty($.hosts.code['/editor'].www.compiled_, 'name', {value: "$.hosts.root.subdomains.code['/editor'].www.compiled_"});
$.hosts.code['/explorer'] = {};
// CLOSURE: type: function, vars: source, jssp
// CLOSURE: type: funexp, vars: Jssp
$.hosts.code['/explorer'].www = function jssp(request, response) {
  // DO NOT EDIT THIS CODE.  AUTOMATICALLY GENERATED BY JSSP.
  // To edit contents of generated page, edit this.source.
  return jssp.render(this, request, response);  // See $.Jssp for explanation.
};
Object.setPrototypeOf($.hosts.code['/explorer'].www, $.Jssp.prototype);
Object.setOwnerOf($.hosts.code['/explorer'].www, $.physicals.Neil);
Object.setOwnerOf($.hosts.code['/explorer'].www.prototype, $.physicals.Neil);
$.hosts.code['/explorer'].www.source = '<!doctype html>\n<% var staticUrl = request.hostUrl(\'static\'); %>\n<html>\n  <head>\n    <meta charset="utf-8"/>\n    <title>Code City: Code Explorer</title>\n    <link rel="stylesheet" href="<%=staticUrl%>code/style.css">\n    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto+Mono">\n    <script src="<%=staticUrl%>code/common.js"></script>\n    <script src="<%=staticUrl%>code/explorer.js"></script>\n  </head>\n  <body>\n    <input type="text" id="input" autocomplete="off">\n    <div id="autocompleteMenu"><div id="autocompleteMenuScroll"></div></div>\n    <div id="panels"><div id="panelsScroll"><span id="panelSpacer"></span></div></div>\n  </body>\n</html>\n';
$.hosts.code['/explorer'].www.hash_ = '7ff39ae0bddd6b64b81f9e0ba9e23afbv1.0.0';
$.hosts.code['/explorer'].www.compiled_ = function(request, response) {
// DO NOT EDIT THIS CODE: AUTOMATICALLY GENERATED BY JSSP.
response.write("<!doctype html>\n");
 var staticUrl = request.hostUrl('static'); 
response.write("\n<html>\n  <head>\n    <meta charset=\"utf-8\"/>\n    <title>Code City: Code Explorer</title>\n    <link rel=\"stylesheet\" href=\"");
...
response.write("code/common.js\"></script>\n    <script src=\"");
response.write(staticUrl);
response.write("code/explorer.js\"></script>\n  </head>\n  <body>\n    <input type=\"text\" id=\"input\" autocomplete=\"off\">\n    <div id=\"autocompleteMenu\"><div id=\"autocompleteMenuScroll\"></div></div>\n    <div id=\"panels\"><div id=\"panelsScroll\"><span id=\"panelSpacer\"></span></div></div>\n  </body>\n</html>");
};
Object.setOwnerOf($.hosts.code['/explorer'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.hosts.code['/explorer'].www.compiled_.prototype, $.physicals.Neil);
Object.defineProperty($.hosts.code['/explorer'].www.compiled_, 'name', {value: "$.hosts.root.subdomains.code['/explorer'].www.compiled_"});
$.hosts.code['/diff'] = {};
// CLOSURE: type: function, vars: source, jssp
// CLOSURE: type: funexp, vars: Jssp
$.hosts.code['/diff'].www = function jssp(request, response) {
  // DO NOT EDIT THIS CODE.  AUTOMATICALLY GENERATED BY JSSP.
  // To edit contents of generated page, edit this.source.
  return jssp.render(this, request, response);  // See $.Jssp for explanation.
};
Object.setPrototypeOf($.hosts.code['/diff'].www, $.Jssp.prototype);
Object.setOwnerOf($.hosts.code['/diff'].www, $.physicals.Neil);
Object.setOwnerOf($.hosts.code['/diff'].www.prototype, $.physicals.Neil);
$.hosts.code['/diff'].www.source = '<% var staticUrl = request.hostUrl(\'static\'); %>\n<html>\n  <head>\n    <title>Code City Diff Editor</title>\n    <script src="<%=staticUrl%>code/mobwrite/dmp.js"></script>\n    <script src="<%=staticUrl%>code/diff.js"></script>\n    <link rel="stylesheet" href="<%=staticUrl%>code/diff.css">\n  </head>\n\n  <body>\n  </body>\n</html>\n';
$.hosts.code['/diff'].www.hash_ = '99ba410e68c75ccfc6848c157c259ed6v1.0.0';
$.hosts.code['/diff'].www.compiled_ = function(request, response) {
// DO NOT EDIT THIS CODE: AUTOMATICALLY GENERATED BY JSSP.
 var staticUrl = request.hostUrl('static'); 
response.write("\n<html>\n  <head>\n    <title>Code City Diff Editor</title>\n    <script src=\"");
response.write(staticUrl);
response.write("code/mobwrite/dmp.js\"></script>\n    <script src=\"");
response.write(staticUrl);
response.write("code/diff.js\"></script>\n    <link rel=\"stylesheet\" href=\"");
response.write(staticUrl);
response.write("code/diff.css\">\n  </head>\n\n  <body>\n  </body>\n</html>");
};
Object.setOwnerOf($.hosts.code['/diff'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.hosts.code['/diff'].www.compiled_.prototype, $.physicals.Neil);
Object.defineProperty($.hosts.code['/diff'].www.compiled_, 'name', {value: "$.http['code.']['/diff'].www.compiled_"});
$.hosts.code['/objectPanel'] = {};
// CLOSURE: type: function, vars: source, jssp
// CLOSURE: type: funexp, vars: Jssp
$.hosts.code['/objectPanel'].www = function jssp(request, response) {
  // DO NOT EDIT THIS CODE.  AUTOMATICALLY GENERATED BY JSSP.
  // To edit contents of generated page, edit this.source.
  return jssp.render(this, request, response);  // See $.Jssp for explanation.
};
Object.setPrototypeOf($.hosts.code['/objectPanel'].www, $.Jssp.prototype);
Object.setOwnerOf($.hosts.code['/objectPanel'].www, $.physicals.Neil);
Object.setOwnerOf($.hosts.code['/objectPanel'].www.prototype, $.physicals.Neil);
$.hosts.code['/objectPanel'].www.source = '<!doctype html>\n<% var staticUrl = request.hostUrl(\'static\'); %>\n<html>\n  <head>\n    <meta charset="utf-8"/>\n    <title>Code City: Code Object Panel</title>\n    <link rel="stylesheet" href="<%=staticUrl%>code/style.css">\n    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto+Mono">\n  </head>\n  <body id="objectPanel">\n    <table id="objectTable">\n      <thead>\n        <tr><td id="objectTitle">&#8203;</td></tr>\n      </thead>\n      <tbody id="objectTableBody">\n        <tr><td class="loading">&#8203;</td></tr> <!-- Zero width space to align the loading ellipsis. -->\n      </tbody>\n      <tfoot id="objectFail">\n        <tr><td>Server Error<br>Check your console&hellip;</td></tr>\n      </tfoot>\n    </table>\n    <script src="<%=staticUrl%>code/common.js"></script>\n    <script src="<%=staticUrl%>code/objectPanel.js"></script>\n    <script>\n      Code.ObjectPanel.data = <%=JSON.stringify(this.buildData(request.query), null, 2)%>;\n    </script>\n  </body>\n</html>\n';
$.hosts.code['/objectPanel'].www.hash_ = 'ab69f5e570ef2018a08e521927e51763v1.0.0';
$.hosts.code['/objectPanel'].www.compiled_ = function(request, response) {
// DO NOT EDIT THIS CODE: AUTOMATICALLY GENERATED BY JSSP.
response.write("<!doctype html>\n");
 var staticUrl = request.hostUrl('static'); 
response.write("\n<html>\n  <head>\n    <meta charset=\"utf-8\"/>\n    <title>Code City: Code Object Panel</title>\n    <link rel=\"stylesheet\" href=\"");
...
response.write("code/common.js\"></script>\n    <script src=\"");
response.write(staticUrl);
response.write("code/objectPanel.js\"></script>\n    <script>\n      Code.ObjectPanel.data = ");
response.write(JSON.stringify(this.buildData(request.query), null, 2));
response.write(";\n    </script>\n  </body>\n</html>");
};
Object.setOwnerOf($.hosts.code['/objectPanel'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.hosts.code['/objectPanel'].www.compiled_.prototype, $.physicals.Neil);
Object.defineProperty($.hosts.code['/objectPanel'].www.compiled_, 'name', {value: "$.hosts.root.subdomains.code['/objectPanel'].www.compiled_"});
...
response.write(staticUrl);
response.write("login-close.html\"></iframe>\n</body>\n</html>");
};
Object.setOwnerOf($.hosts.code['/login'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.hosts.code['/login'].www.compiled_.prototype, $.physicals.Neil);
Object.defineProperty($.hosts.code['/login'].www.compiled_, 'name', {value: "$.hosts.code['/login'].www.compiled_"});
$.hosts.code['/mirror'] = $.hosts.test['/mirror'];
