...
$.hosts.code['/editorXhr'].handleMetaData = function handleMetaData(src, oldValue, newValue) {
  ...
  //
  // The $.http['code.']['/editor'].www sends values to be edited to the
...
Object.setOwnerOf($.hosts.code['/editorXhr'].handleMetaData, $.physicals.Neil);
$.hosts.code['/editorXhr'].generateMetaData = function generateMetaData(value, inherited) {
   ...
   *     value.
   *
   * Returns: string - metadata informing $.http['code.']['/editorXhr'].save
...
Object.setOwnerOf($.hosts.code['/editorXhr'].generateMetaData, $.physicals.Neil);
$.hosts.code['/svg'] = {};
...
$.http['code.']['/'] = $.hosts.code['/'];
$.http['code.']['/editor'] = $.hosts.code['/editor'];
$.http['code.']['/explorer'] = $.hosts.code['/explorer'];
$.http['code.']['/diff'] = $.hosts.code['/diff'];
$.http['code.']['/objectPanel'] = $.hosts.code['/objectPanel'];
$.http['code.']['/editorXhr'] = $.hosts.code['/editorXhr'];
$.http['code.']['/svg'] = $.hosts.code['/svg'];
$.http['code.']['/login'] = $.hosts.code['/login'];
