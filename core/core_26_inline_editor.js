...
$.http['code.']['/inlineEdit'] = {};
$.http['code.']['/inlineEdit'].edit = function edit(obj, name, key) {
  ...
  var url = $.servers.http.makeUrl('code', 'inlineEdit?objId=' + objId);
  if (name) {
...
Object.setOwnerOf($.http['code.']['/inlineEdit'].edit, $.physicals.Neil);
$.http['code.']['/inlineEdit'].load = function load(obj, key) {
...
Object.setOwnerOf($.http['code.']['/inlineEdit'].load, $.physicals.Maximilian);
$.http['code.']['/inlineEdit'].save = function save(obj, key, src) {
...
Object.setOwnerOf($.http['code.']['/inlineEdit'].save, $.physicals.Maximilian);
$.http['code.']['/inlineEdit'].www = function jssp(request, response) {
...
Object.setOwnerOf($.http['code.']['/inlineEdit'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.http['code.']['/inlineEdit'].www.compiled_.prototype, $.physicals.Neil);
Object.defineProperty($.http['code.']['/inlineEdit'].www.compiled_, 'name', {value: "$.http['code.']['/inlineEdit'].www.compiled_"});
