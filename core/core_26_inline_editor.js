...
$.hosts.code['/inlineEdit'].www = function jssp(request, response) {
...
Object.setOwnerOf($.hosts.code['/inlineEdit'].www.compiled_, $.physicals.Neil);
Object.setOwnerOf($.hosts.code['/inlineEdit'].www.compiled_.prototype, $.physicals.Neil);
Object.defineProperty($.hosts.code['/inlineEdit'].www.compiled_, 'name', {value: "$.hosts.root.subdomains.code['/inlineEdit'].www.compiled_"});
