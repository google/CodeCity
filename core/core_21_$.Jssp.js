...
Object.setOwnerOf($.Jssp, Object.getOwnerOf($.utils.code.rewriteForEval));
...
Object.setOwnerOf($.Jssp.prototype.compile.prototype, Object.getOwnerOf($.Selector.db.get));
...
Object.setOwnerOf($.Jssp.prototype.render, Object.getOwnerOf($.Jssp.prototype.compile));
