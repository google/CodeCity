...
$.www.code.www.source = '<!DOCTYPE HTML Frameset DTD>\n<html>\n<head>\n  <title>Code City: Code</title>\n  <link href="/static/favicon.ico" rel="shortcut icon">\n  <script src="/static/code2/common.js"></script>\n  <script src="/static/code2/code.js"></script>\n</head>\n<frameset rows="40%,60%">\n  <frame id="explorer" src="/static/code2/explorer.html" />\n  <frame id="editor" src="/static/code2/editor.html" />\n</frameset>\n<noframes>Sorry, your browser does not support frames!</noframes>\n</html>';
$.www.code.www.hash_ = 'aa1c51ec596a0bc6ed6980572f3075a3v1.0.0';
$.www.code.www.compiled_ = function(request, response) {
// DO NOT EDIT THIS CODE: AUTOMATICALLY GENERATED BY JSSP.
response.write("<!DOCTYPE HTML Frameset DTD>\n<html>\n<head>\n  <title>Code City: Code</title>\n  <link href=\"/static/favicon.ico\" rel=\"shortcut icon\">\n  <script src=\"/static/code2/common.js\"></script>\n  <script src=\"/static/code2/code.js\"></script>\n</head>\n<frameset rows=\"40%,60%\">\n  <frame id=\"explorer\" src=\"/static/code2/explorer.html\" />\n  <frame id=\"editor\" src=\"/static/code2/editor.html\" />\n</frameset>\n<noframes>Sorry, your browser does not support frames!</noframes>\n</html>");
};
Object.setOwnerOf($.www.code.www.compiled_, Object.getOwnerOf($.Jssp.prototype.compile));
Object.setOwnerOf($.www.code.www.compiled_.prototype, Object.getOwnerOf($.Jssp.prototype.compile));
Object.defineProperty($.www.code.www.compiled_, 'name', {value: '$.www.code.www.compiled_'});
...
$.www.code.objectPanel.getType = function getType(value) {
...
Object.setOwnerOf($.www.code.editor.www, Object.getOwnerOf($.Jssp.OutputBuffer));
Object.setOwnerOf($.www.code.editor.www.prototype, Object.getOwnerOf($.Jssp.OutputBuffer));
...
$.http['code.']['/'].www = function jssp(request, response) {
  // DO NOT EDIT THIS CODE.  AUTOMATICALLY GENERATED BY JSSP.
  // To edit contents of generated page, edit this.source.
  return jssp.render(this, request, response);  // See $.Jssp for explanation.
};
Object.setPrototypeOf($.http['code.']['/'].www, $.Jssp.prototype);
Object.setOwnerOf($.http['code.']['/'].www, Object.getOwnerOf($.Jssp.prototype.compile));
Object.setOwnerOf($.http['code.']['/'].www.prototype, Object.getOwnerOf($.Jssp.prototype.compile));
$.http['code.']['/'].www.source = '<!DOCTYPE HTML Frameset DTD>\n<html>\n<head>\n  <title>Code City: Code</title>\n  <link href="<%=$.servers.http.makeUrl(\'static\', \'favicon.ico\')%>" rel="shortcut icon">\n  <script src="<%=$.servers.http.makeUrl(\'static\', \'code/common.js\')%>"></script>\n  <script src="<%=$.servers.http.makeUrl(\'static\', \'code/code.js\')%>"></script>\n</head>\n<frameset rows="40%,60%">\n  <frame id="explorer" src="explorer" />\n  <frame id="editor" src="editor" />\n</frameset>\n<noframes>Sorry, your browser does not support frames!</noframes>\n</html>';
$.http['code.']['/'].www.hash_ = '4656c74547fe51b7dfb0ae4b4a14c9c9v1.0.0';
$.http['code.']['/'].www.compiled_ = function(request, response) {
// DO NOT EDIT THIS CODE: AUTOMATICALLY GENERATED BY JSSP.
response.write("<!DOCTYPE HTML Frameset DTD>\n<html>\n<head>\n  <title>Code City: Code</title>\n  <link href=\"");
response.write($.servers.http.makeUrl('static', 'favicon.ico'));
response.write("\" rel=\"shortcut icon\">\n  <script src=\"");
response.write($.servers.http.makeUrl('static', 'code/common.js'));
response.write("\"></script>\n  <script src=\"");
response.write($.servers.http.makeUrl('static', 'code/code.js'));
response.write("\"></script>\n</head>\n<frameset rows=\"40%,60%\">\n  <frame id=\"explorer\" src=\"explorer\" />\n  <frame id=\"editor\" src=\"editor\" />\n</frameset>\n<noframes>Sorry, your browser does not support frames!</noframes>\n</html>");
};
Object.setOwnerOf($.http['code.']['/'].www.compiled_, Object.getOwnerOf($.Jssp.prototype.compile));
Object.setOwnerOf($.http['code.']['/'].www.compiled_.prototype, Object.getOwnerOf($.Jssp.prototype.compile));
Object.defineProperty($.http['code.']['/'].www.compiled_, 'name', {value: "$.http['code.']['/'].www.compiled_"});
$.http['code.']['/editor'] = {};
// CLOSURE: type: function, vars: source, jssp
// CLOSURE: type: funexp, vars: Jssp
$.http['code.']['/editor'].www = function jssp(request, response) {
  // DO NOT EDIT THIS CODE.  AUTOMATICALLY GENERATED BY JSSP.
  // To edit contents of generated page, edit this.source.
  return jssp.render(this, request, response);  // See $.Jssp for explanation.
};
Object.setPrototypeOf($.http['code.']['/editor'].www, $.Jssp.prototype);
Object.setOwnerOf($.http['code.']['/editor'].www, Object.getOwnerOf($.Jssp.prototype.compile));
Object.setOwnerOf($.http['code.']['/editor'].www.prototype, Object.getOwnerOf($.Jssp.prototype.compile));
$.http['code.']['/editor'].www.source = '<!doctype html>\n<html>\n  <head>\n    <meta charset="utf-8"/>\n    <title>Code City: Code Editor</title>\n    <link rel="stylesheet" href="<%=$.servers.http.makeUrl(\'static\', \'code/style.css\')%>">\n    <link rel="stylesheet" href="<%=$.servers.http.makeUrl(\'static\', \'code/editor.css\')%>">\n    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto+Mono">\n    <link rel="stylesheet" href="<%=$.servers.http.makeUrl(\'static\', \'style/jfk.css\')%>">\n\n    <link rel="stylesheet" href="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/lib/codemirror.css\')%>">\n    <link rel="stylesheet" href="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/addon/lint/lint.css\')%>">\n    <link rel="stylesheet" href="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/theme/eclipse.css\')%>">\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/lib/codemirror.js\')%>"></script>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/addon/edit/matchbrackets.js\')%>"></script>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/addon/comment/continuecomment.js\')%>"></script>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/addon/mode/multiplex.js\')%>"></script>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/addon/lint/lint.js\')%>"></script>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/addon/lint/javascript-lint.js\')%>"></script>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/addon/display/rulers.js\')%>"></script>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/mode/css/css.js\')%>"></script>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/mode/htmlembedded/htmlembedded.js\')%>"></script>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/mode/htmlmixed/htmlmixed.js\')%>"></script>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/mode/javascript/javascript.js\')%>"></script>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'CodeMirror/mode/xml/xml.js\')%>"></script>\n\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'code/common.js\')%>"></script>\n    <script id="editor_js" src="<%=$.servers.http.makeUrl(\'static\', \'code/editor.js\')%>"></script>\n  </head>\n  <body>\n    <div id="editorDialog">\n      <div id="editorDialogMask"></div>\n      <div id="editorDialogBox">\n        <div id="editorConfirmBox">\n          <p>Do you want to save changes?</p>\n          <p>\n            <button id="editorConfirmDiscard" class="jfk-button">Discard</button>\n            <button id="editorConfirmSave" class="jfk-button jfk-button-submit">Save</button>\n            <button id="editorConfirmCancel" class="jfk-button">Cancel</button>\n          </p>\n        </div>\n        <div id="editorShareBox" class="disabled">\n          <p>\n            <label><input type="checkbox" id="editorShareCheck" disabled> Share this editor:</label>\n          </p>\n          <p>\n            <input id="editorShareAddress" readonly>\n          </p>\n          <p>\n            <button id="editorShareOk" class="jfk-button jfk-button-submit">Ok</button>\n          </p>\n        </div>\n      </div>\n    </div>\n    <div id="editorButter"><div><div id="editorButterText"></div></div></div>\n    <div id="editorSavingMask"></div>\n    <div id="editorButtons">\n      <button id="editorShare" class="jfk-button">Share...</button>\n      <button id="editorSave" class="jfk-button">Save</button>\n    </div>\n    <div id="editorTabs" class="disabled">\n      <span class="spacer"></span>\n    </div>\n    <div id="editorHeader" class="loading"></div>\n    <div id="editorContainers"></div>\n  </body>\n</html>\n';
$.http['code.']['/editor'].www.hash_ = 'f87af2923a3df790621b94b3de494c03v1.0.0';
$.http['code.']['/editor'].www.compiled_ = function(request, response) {
// DO NOT EDIT THIS CODE: AUTOMATICALLY GENERATED BY JSSP.
response.write("<!doctype html>\n<html>\n  <head>\n    <meta charset=\"utf-8\"/>\n    <title>Code City: Code Editor</title>\n    <link rel=\"stylesheet\" href=\"");
response.write($.servers.http.makeUrl('static', 'code/style.css'));
response.write("\">\n    <link rel=\"stylesheet\" href=\"");
response.write($.servers.http.makeUrl('static', 'code/editor.css'));
response.write("\">\n    <link rel=\"stylesheet\" href=\"https://fonts.googleapis.com/css?family=Roboto+Mono\">\n    <link rel=\"stylesheet\" href=\"");
...
response.write("\"></script>\n    <script src=\"");
response.write($.servers.http.makeUrl('static', 'CodeMirror/addon/mode/multiplex.js'));
response.write("\"></script>\n    <script src=\"");
...
response.write("\"></script>\n    <script src=\"");
response.write($.servers.http.makeUrl('static', 'CodeMirror/mode/css/css.js'));
response.write("\"></script>\n    <script src=\"");
response.write($.servers.http.makeUrl('static', 'CodeMirror/mode/htmlembedded/htmlembedded.js'));
response.write("\"></script>\n    <script src=\"");
response.write($.servers.http.makeUrl('static', 'CodeMirror/mode/htmlmixed/htmlmixed.js'));
response.write("\"></script>\n    <script src=\"");
response.write($.servers.http.makeUrl('static', 'CodeMirror/mode/javascript/javascript.js'));
response.write("\"></script>\n    <script src=\"");
response.write($.servers.http.makeUrl('static', 'CodeMirror/mode/xml/xml.js'));
response.write("\"></script>\n\n    <script src=\"");
response.write($.servers.http.makeUrl('static', 'code/common.js'));
response.write("\"></script>\n    <script id=\"editor_js\" src=\"");
response.write($.servers.http.makeUrl('static', 'code/editor.js'));
response.write("\"></script>\n  </head>\n  <body>\n    <div id=\"editorDialog\">\n      <div id=\"editorDialogMask\"></div>\n      <div id=\"editorDialogBox\">\n        <div id=\"editorConfirmBox\">\n          <p>Do you want to save changes?</p>\n          <p>\n            <button id=\"editorConfirmDiscard\" class=\"jfk-button\">Discard</button>\n            <button id=\"editorConfirmSave\" class=\"jfk-button jfk-button-submit\">Save</button>\n            <button id=\"editorConfirmCancel\" class=\"jfk-button\">Cancel</button>\n          </p>\n        </div>\n        <div id=\"editorShareBox\" class=\"disabled\">\n          <p>\n            <label><input type=\"checkbox\" id=\"editorShareCheck\" disabled> Share this editor:</label>\n          </p>\n          <p>\n            <input id=\"editorShareAddress\" readonly>\n          </p>\n          <p>\n            <button id=\"editorShareOk\" class=\"jfk-button jfk-button-submit\">Ok</button>\n          </p>\n        </div>\n      </div>\n    </div>\n    <div id=\"editorButter\"><div><div id=\"editorButterText\"></div></div></div>\n    <div id=\"editorSavingMask\"></div>\n    <div id=\"editorButtons\">\n      <button id=\"editorShare\" class=\"jfk-button\">Share...</button>\n      <button id=\"editorSave\" class=\"jfk-button\">Save</button>\n    </div>\n    <div id=\"editorTabs\" class=\"disabled\">\n      <span class=\"spacer\"></span>\n    </div>\n    <div id=\"editorHeader\" class=\"loading\"></div>\n    <div id=\"editorContainers\"></div>\n  </body>\n</html>");
};
Object.setOwnerOf($.http['code.']['/editor'].www.compiled_, Object.getOwnerOf($.Jssp.prototype.compile));
Object.setOwnerOf($.http['code.']['/editor'].www.compiled_.prototype, Object.getOwnerOf($.Jssp.prototype.compile));
Object.defineProperty($.http['code.']['/editor'].www.compiled_, 'name', {value: "$.http['code.']['/editor'].www.compiled_"});
$.http['code.']['/explorer'] = {};
// CLOSURE: type: function, vars: source, jssp
// CLOSURE: type: funexp, vars: Jssp
$.http['code.']['/explorer'].www = function jssp(request, response) {
  // DO NOT EDIT THIS CODE.  AUTOMATICALLY GENERATED BY JSSP.
  // To edit contents of generated page, edit this.source.
  return jssp.render(this, request, response);  // See $.Jssp for explanation.
};
Object.setPrototypeOf($.http['code.']['/explorer'].www, $.Jssp.prototype);
Object.setOwnerOf($.http['code.']['/explorer'].www, Object.getOwnerOf($.Jssp.prototype.compile));
Object.setOwnerOf($.http['code.']['/explorer'].www.prototype, Object.getOwnerOf($.Jssp.prototype.compile));
$.http['code.']['/explorer'].www.source = '<!doctype html>\n<html>\n  <head>\n    <meta charset="utf-8"/>\n    <title>Code City: Code Explorer</title>\n    <link rel="stylesheet" href="<%=$.servers.http.makeUrl(\'static\', \'code/style.css\')%>">\n    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto+Mono">\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'code/common.js\')%>"></script>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'code/explorer.js\')%>"></script>\n  </head>\n  <body>\n    <input type="text" id="input" autocomplete="off">\n    <div id="autocompleteMenu"><div id="autocompleteMenuScroll"></div></div>\n    <div id="panels"><div id="panelsScroll"><span id="panelSpacer"></span></div></div>\n  </body>\n</html>\n';
$.http['code.']['/explorer'].www.hash_ = '066010798d842bff299a535403130337v1.0.0';
$.http['code.']['/explorer'].www.compiled_ = function(request, response) {
// DO NOT EDIT THIS CODE: AUTOMATICALLY GENERATED BY JSSP.
response.write("<!doctype html>\n<html>\n  <head>\n    <meta charset=\"utf-8\"/>\n    <title>Code City: Code Explorer</title>\n    <link rel=\"stylesheet\" href=\"");
response.write($.servers.http.makeUrl('static', 'code/style.css'));
response.write("\">\n    <link rel=\"stylesheet\" href=\"https://fonts.googleapis.com/css?family=Roboto+Mono\">\n    <script src=\"");
response.write($.servers.http.makeUrl('static', 'code/common.js'));
response.write("\"></script>\n    <script src=\"");
response.write($.servers.http.makeUrl('static', 'code/explorer.js'));
response.write("\"></script>\n  </head>\n  <body>\n    <input type=\"text\" id=\"input\" autocomplete=\"off\">\n    <div id=\"autocompleteMenu\"><div id=\"autocompleteMenuScroll\"></div></div>\n    <div id=\"panels\"><div id=\"panelsScroll\"><span id=\"panelSpacer\"></span></div></div>\n  </body>\n</html>");
};
Object.setOwnerOf($.http['code.']['/explorer'].www.compiled_, Object.getOwnerOf($.Jssp.prototype.compile));
Object.setOwnerOf($.http['code.']['/explorer'].www.compiled_.prototype, Object.getOwnerOf($.Jssp.prototype.compile));
Object.defineProperty($.http['code.']['/explorer'].www.compiled_, 'name', {value: "$.http['code.']['/explorer.html'].www.compiled_"});
$.http['code.']['/diff'] = {};
// CLOSURE: type: function, vars: source, jssp
// CLOSURE: type: funexp, vars: Jssp
$.http['code.']['/diff'].www = function jssp(request, response) {
  // DO NOT EDIT THIS CODE.  AUTOMATICALLY GENERATED BY JSSP.
  // To edit contents of generated page, edit this.source.
  return jssp.render(this, request, response);  // See $.Jssp for explanation.
};
Object.setPrototypeOf($.http['code.']['/diff'].www, $.Jssp.prototype);
Object.setOwnerOf($.http['code.']['/diff'].www, Object.getOwnerOf($.Jssp.prototype.compile));
Object.setOwnerOf($.http['code.']['/diff'].www.prototype, Object.getOwnerOf($.Jssp.prototype.compile));
$.http['code.']['/diff'].www.source = "<html>\n  <head>\n    <title>Code City Diff Editor</title>\n    <script src=\"<%=$.servers.http.makeUrl('static', 'code/mobwrite/dmp.js')%>\"></script>\n    <script src=\"<%=$.servers.http.makeUrl('static', 'code/diff.js')%>\"></script>\n    <link rel=\"stylesheet\" href=\"<%=$.servers.http.makeUrl('static', 'code/diff.css')%>\">\n  </head>\n\n  <body>\n  </body>\n</html>\n";
$.http['code.']['/diff'].www.hash_ = '3288fc71f4dff5c1118ff2f6442ca82av1.0.0';
$.http['code.']['/diff'].www.compiled_ = function(request, response) {
// DO NOT EDIT THIS CODE: AUTOMATICALLY GENERATED BY JSSP.
response.write("<html>\n  <head>\n    <title>Code City Diff Editor</title>\n    <script src=\"");
response.write($.servers.http.makeUrl('static', 'code/mobwrite/dmp.js'));
response.write("\"></script>\n    <script src=\"");
response.write($.servers.http.makeUrl('static', 'code/diff.js'));
response.write("\"></script>\n    <link rel=\"stylesheet\" href=\"");
response.write($.servers.http.makeUrl('static', 'code/diff.css'));
response.write("\">\n  </head>\n\n  <body>\n  </body>\n</html>");
};
Object.setOwnerOf($.http['code.']['/diff'].www.compiled_, Object.getOwnerOf($.Jssp.prototype.compile));
Object.setOwnerOf($.http['code.']['/diff'].www.compiled_.prototype, Object.getOwnerOf($.Jssp.prototype.compile));
Object.defineProperty($.http['code.']['/diff'].www.compiled_, 'name', {value: "$.http['code.']['/editor.html'].www.compiled_"});
$.http['code.']['/objectPanel'] = {};
// CLOSURE: type: function, vars: source, jssp
// CLOSURE: type: funexp, vars: Jssp
$.http['code.']['/objectPanel'].www = function jssp(request, response) {
  // DO NOT EDIT THIS CODE.  AUTOMATICALLY GENERATED BY JSSP.
  // To edit contents of generated page, edit this.source.
  return jssp.render(this, request, response);  // See $.Jssp for explanation.
};
Object.setPrototypeOf($.http['code.']['/objectPanel'].www, $.Jssp.prototype);
Object.setOwnerOf($.http['code.']['/objectPanel'].www, Object.getOwnerOf($.Jssp.prototype.compile));
Object.setOwnerOf($.http['code.']['/objectPanel'].www.prototype, Object.getOwnerOf($.Jssp.prototype.compile));
$.http['code.']['/objectPanel'].www.source = '<!doctype html>\n<html>\n  <head>\n    <meta charset="utf-8"/>\n    <title>Code City: Code Object Panel</title>\n    <link rel="stylesheet" href="<%=$.servers.http.makeUrl(\'static\', \'code/style.css\')%>">\n    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto+Mono">\n  </head>\n  <body id="objectPanel">\n    <table id="objectTable">\n      <thead>\n        <tr><td id="objectTitle">&#8203;</td></tr>\n      </thead>\n      <tbody id="objectTableBody">\n        <tr><td class="loading">&#8203;</td></tr> <!-- Zero width space to align the loading ellipsis. -->\n      </tbody>\n      <tfoot id="objectFail">\n        <tr><td>Server Error<br>Check your console&hellip;</td></tr>\n      </tfoot>\n    </table>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'code/common.js\')%>"></script>\n    <script src="<%=$.servers.http.makeUrl(\'static\', \'code/objectPanel.js\')%>"></script>\n    <script>\n      Code.ObjectPanel.data = <%=JSON.stringify(this.buildData(request.query), null, 2)%>;\n    </script>\n  </body>\n</html>\n';
$.http['code.']['/objectPanel'].www.hash_ = 'cc362f7c6ed954076f07efd2a1df9670v1.0.0';
$.http['code.']['/objectPanel'].www.compiled_ = function(request, response) {
// DO NOT EDIT THIS CODE: AUTOMATICALLY GENERATED BY JSSP.
response.write("<!doctype html>\n<html>\n  <head>\n    <meta charset=\"utf-8\"/>\n    <title>Code City: Code Object Panel</title>\n    <link rel=\"stylesheet\" href=\"");
response.write($.servers.http.makeUrl('static', 'code/style.css'));
response.write("\">\n    <link rel=\"stylesheet\" href=\"https://fonts.googleapis.com/css?family=Roboto+Mono\">\n  </head>\n  <body id=\"objectPanel\">\n    <table id=\"objectTable\">\n      <thead>\n        <tr><td id=\"objectTitle\">&#8203;</td></tr>\n      </thead>\n      <tbody id=\"objectTableBody\">\n        <tr><td class=\"loading\">&#8203;</td></tr> <!-- Zero width space to align the loading ellipsis. -->\n      </tbody>\n      <tfoot id=\"objectFail\">\n        <tr><td>Server Error<br>Check your console&hellip;</td></tr>\n      </tfoot>\n    </table>\n    <script src=\"");
response.write($.servers.http.makeUrl('static', 'code/common.js'));
response.write("\"></script>\n    <script src=\"");
response.write($.servers.http.makeUrl('static', 'code/objectPanel.js'));
response.write("\"></script>\n    <script>\n      Code.ObjectPanel.data = ");
response.write(JSON.stringify(this.buildData(request.query), null, 2));
response.write(";\n    </script>\n  </body>\n</html>");
};
Object.setOwnerOf($.http['code.']['/objectPanel'].www.compiled_, Object.getOwnerOf($.Jssp.prototype.compile));
Object.setOwnerOf($.http['code.']['/objectPanel'].www.compiled_.prototype, Object.getOwnerOf($.Jssp.prototype.compile));
Object.defineProperty($.http['code.']['/objectPanel'].www.compiled_, 'name', {value: "$.http['code.']['/objectPanel'].www.compiled_"});
$.http['code.']['/objectPanel'].getType = $.www.code.objectPanel.getType;
$.http['code.']['/objectPanel'].buildData = function buildData(query) {
  // Provide data for the IDE's object panels.
  // Takes one input: a JSON-encoded list of parts from the 'parts' parameter.
...
Object.setOwnerOf($.http['code.']['/objectPanel'].buildData, Object.getOwnerOf($.Jssp.prototype.compile));
Object.setOwnerOf($.http['code.']['/objectPanel'].buildData.prototype, Object.getOwnerOf($.Jssp.prototype.compile));
$.http['code.']['/editorXhr'] = {};
Object.setOwnerOf($.http['code.']['/editorXhr'], Object.getOwnerOf($.Jssp.prototype.compile));
$.http['code.']['/editorXhr'].www = function code_editorXhr_www(request, response) {
...
response.write($.servers.http.makeUrl('login', '?loginThenClose'));
response.write("\"></iframe>\n</body>\n</html>");
};
Object.setOwnerOf($.http['code.']['/login'].www.compiled_, Object.getOwnerOf($.Jssp.prototype.compile));
Object.setOwnerOf($.http['code.']['/login'].www.compiled_.prototype, Object.getOwnerOf($.Jssp.prototype.compile));
Object.defineProperty($.http['code.']['/login'].www.compiled_, 'name', {value: "$.http['code.']['/login'].www.compiled_"});
