...
function sendAutocomplete(parts) {
  ...
  xhr.send('parts=' + encodeURIComponent(parts));
  console.log('Sending to CC: ' + parts);
}
...
function autocompleteClick(e) {
  ...
  var parts = JSON.parse(oldInputParts);
  parts.push(option);
  setInput(parts);
}
